// src/qaTaskFlow/trace/index.ts

/**
 * ============================================================================
 * FilesUP-Taskflow (filesup-asc) — Trace + Flow Context (Events + Contracts)
 * ============================================================================
 * This is: src/qaTaskFlow/trace/index.ts
 *
 * Used by:
 * - src/qaTaskFlow/runtime/* (Flow runtime / runner) / (not used yet)
 * - src/qaTaskFlow/flows/* (Flow orchestrators) / (not used yet)
 * - src/qaTaskFlow/contracts/* (Contract helpers) / (not used yet)
 *
 * Purpose:
